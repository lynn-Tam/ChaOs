...
#define MYOS_STATUS_REASSERTED     -14
#define MYOS_STATUS_ALREADY_CONNECTED -15
#define MYOS_STATUS_WOULD_BLOCK      -16
#define MYOS_STATUS_PEER_FAULT       -17
#define MYOS_STATUS_CANCELED         -18
#define MYOS_STATUS_PEER_ABORTED      -19
