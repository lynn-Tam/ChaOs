...
#define MYOS_ENDPOINT_CALL_BLOCK 0U
#define MYOS_ENDPOINT_CALL_ASYNC 1U
#define MYOS_ENDPOINT_MODE_BLOCK (UINT64_C(1) << MYOS_ENDPOINT_CALL_BLOCK)
#define MYOS_ENDPOINT_MODE_ASYNC (UINT64_C(1) << MYOS_ENDPOINT_CALL_ASYNC)
