...
class ExecutionBinding final : private libk::noncopyable {
    ...
    using Roots = libk::variant<DetachedRoots, KernelRoots, UserRoots>;
...
public:
    ...
    [[nodiscard]] auto user_bound() const noexcept -> bool {
        return libk::holds_alternative<UserRoots>(roots_);
    }
    [[nodiscard]] auto detached() const noexcept -> bool {
        return libk::holds_alternative<DetachedRoots>(roots_);
    }
